...
import { calculateMatrixSumOrSubtraction } from "./calculateMatrix";
 ...
 * @returns Novo valor
 */
export async function calculateNewMatrixSumOrSubtraction(matrixOne: IMatrixBase[], matrixTwo: IMatrixBase[], sinal: SinalCalc): Promise<IMatrixBase[]> {
    try {
        ...
        while (numberCalculatedLine < numberLinesAll && numberCalculatedColumn < numberColumnsAll) {
            ...
            let valueInMatrix = calculateMatrixSumOrSubtraction(matrixOne, matrixTwo, sinal, newOrder)
