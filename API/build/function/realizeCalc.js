 ...
 */
function realizeCalc(sinal, index, reference, calcArray, numberLine, numberColumn) {
    try {
        ...
        // Realizar calculo
        let value = (0, calculate_1.calculate)(sinal, elementOne, elementTwo);
        if (value == undefined) {
            throw new Error(`Valor vindo do calculo está undefined`);
        }
        return value;
    }
    catch (error) {
...
exports.realizeCalc = realizeCalc;
