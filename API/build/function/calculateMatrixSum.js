...
exports.calculateNewMatrixSumOrSubtracion = void 0;
 ...
 * @returns Novo valor
 */
function calculateNewMatrixSumOrSubtracion(matrixOne, matrixTwo, sinal) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            while (numberCalculatedLine < numberLinesAll && numberCalculatedColumn < numberColumnsAll) {
                ...
                let valueInMatrix = (0, calculateMatrix_1.calculateMatrixSumOrSubtracion)(matrixOne, matrixTwo, sinal, newOrder);
...
exports.calculateNewMatrixSumOrSubtracion = calculateNewMatrixSumOrSubtracion;
