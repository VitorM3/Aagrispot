    ...
    create(predefinitionsMatrix) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let matrize = [];
                matrize = yield (0, createMatrix_1.createMatrix)(matrize, numberLines, numberColumns, newArrayCalc);
                return matrize;
            }
            catch (error) {
            ...
            try {
                ...
                switch (baseToCreateANewMatrix.sinalOperation) {
                    case "+":
                        ...
                        newMatrix = yield (0, calculateMatrixSum_1.calculateNewMatrixSumOrSubtraction)(baseToCreateANewMatrix.matrixOne, baseToCreateANewMatrix.matrixTwo, baseToCreateANewMatrix.sinalOperation);
                        return newMatrix;
                    case "-":
                        if (numberMaxColumnOne != numberMaxColumnTwo && numberMaxLineOne != numberMaxLineTwo) {
                            const errorClient = { messageErrorClient: 'Arrays must have the same order', status: 406 };
